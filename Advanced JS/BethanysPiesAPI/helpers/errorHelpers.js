let logRepo = require('../repos/logRepo'); // import logRepo module


/* insert custom middleware for exception handling, function contains 4 parameters, 
    this tells Express that this is for exception handling */
let errorHelpers = {
...
module.exports = errorHelpers; // export the module